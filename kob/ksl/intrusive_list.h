...
#ifndef KOB_KSL_INTRUSIVE_LIST_H_
#define KOB_KSL_INTRUSIVE_LIST_H_
...
namespace ksl {
    ...
    struct intrusive_list_node {
        ...
        ~intrusive_list_node()
        {
            KOB_ASSERT_MSG(!next, "next not null");
            KOB_ASSERT_MSG(!prev, "next not null");
        }
    ...
    public:
        ...
        bool            empty() const KOB_NOEXCEPT;
        size_t          size() const KOB_NOEXCEPT;
        void            clear() KOB_NOEXCEPT;
        void            pop_front();
        void            pop_back();
        void            reverse() KOB_NOEXCEPT;
    ...
    public:
        ...
        iterator                begin() KOB_NOEXCEPT;
        const_iterator          begin() const KOB_NOEXCEPT;
        const_iterator          cbegin() const KOB_NOEXCEPT;

        iterator                end() KOB_NOEXCEPT;
        const_iterator          end() const KOB_NOEXCEPT;
        const_iterator          cend() const KOB_NOEXCEPT;

        reverse_iterator        rbegin() KOB_NOEXCEPT;
        const_reverse_iterator  rbegin() const KOB_NOEXCEPT;
        const_reverse_iterator  crbegin() const KOB_NOEXCEPT;

        reverse_iterator        rend() KOB_NOEXCEPT;
        const_reverse_iterator  rend() const KOB_NOEXCEPT;
        const_reverse_iterator  crend() const KOB_NOEXCEPT;
    ...
    inline bool intrusive_list_base::empty() const KOB_NOEXCEPT
    {
        return _anchor.prev == &_anchor;
    }


    inline intrusive_list_base::size_type intrusive_list_base::size() const KOB_NOEXCEPT
    {
    ...
    inline void intrusive_list_base::clear() KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::iterator intrusive_list<T>::begin() KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_iterator intrusive_list<T>::begin() const KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_iterator intrusive_list<T>::cbegin() const KOB_NOEXCEPT
    {
        return const_iterator(static_cast<T*>(_anchor.next));
    }
    ...
    template <typename T>
    inline typename intrusive_list<T>::iterator intrusive_list<T>::end() KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_iterator intrusive_list<T>::end() const KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_iterator intrusive_list<T>::cend() const KOB_NOEXCEPT
    {
        return const_iterator(static_cast<const T*>(&_anchor));
    }
    ...
    template <typename T>
    inline typename intrusive_list<T>::reverse_iterator intrusive_list<T>::rbegin() KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::rbegin() const KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::crbegin() const KOB_NOEXCEPT
    {
        return const_reverse_iterator(const_iterator(static_cast<const T*>(&_anchor)));
    }
    ...
    template <typename T>
    inline typename intrusive_list<T>::reverse_iterator intrusive_list<T>::rend() KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::rend() const KOB_NOEXCEPT
    {
    ...
    template <typename T>
    inline typename intrusive_list<T>::const_reverse_iterator intrusive_list<T>::crend() const KOB_NOEXCEPT
    {
        return const_reverse_iterator(const_iterator(static_cast<const T*>(_anchor.next)));
    }
    ...
    {
        KOB_ASSERT_MSG(_anchor.next == &_anchor,"intrusive_list::front(): empty list.");
    ...
    inline void intrusive_list<T>::push_front(value_type& x)
    {
        ...
        KOB_ASSERT_MSG(!x.next || !x.prev,"intrusive_list::front(): empty list.");
        x.next = _anchor.next;
        x.prev = &_anchor;
        _anchor.next = &x;
        x.next->prev = &x;
    ...
    {
        KOB_ASSERT_MSG((!x.next || !x.prev),"intrusive_list::push_back(): not empty list.");
        x.prev = _anchor.prev;
        x.next = &_anchor;
        _anchor.prev = &x;
        x.prev->next = &x;
...
#endif //KOB_KSL_INTRUSIVE_LIST_H_
